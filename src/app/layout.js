...
export default function RootLayout({ children }) {
  ...
  {/* GitHub */}
  <a href="https://github.com/eeelsa1" target="_blank" rel="noopener noreferrer">
  ...
  {/* Facebook */}
  <a href="https://www.facebook.com/yourname" target="_blank" rel="noopener noreferrer">
    <div className="bg-gray-300 w-[40px] h-[40px] rounded-full flex justify-center items-center">
      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
  ...
  {/* Instagram */}
  <a href="https://www.instagram.com/yourname" target="_blank" rel="noopener noreferrer">
    <div className="bg-gray-300 w-[40px] h-[40px] rounded-full flex justify-center items-center">
      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
